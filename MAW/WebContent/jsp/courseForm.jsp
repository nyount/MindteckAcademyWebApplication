...
<center>
	<form method="POST" class="form" action="action.do?action=insertcourse" onsubmit="validateForm()">
		...
		<table style="text-align: center">
			...
			<tr>
				<td>Start Date</td>
				<td><input type="text" id="start_date" name="start_date" class="datepicker" readonly/></td>
			</tr>
			<tr>
				<td>End Date</td>
				<td><input type="text" id="end_date" name="end_date" class="datepicker" readonly/></td>
			</tr>
			<tr>
				<td>Location</td>
			...
			<tr>
				<td>Instructor</td>
				<td><select id="instructor_id" name="instructor_id">
