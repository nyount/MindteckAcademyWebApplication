...
<center>
	<form method="POST" class="form" action="action.do?action=updateassignment" onsubmit="validateForm()">
		<input type="hidden" name="id" value='${param["id"]}'/>
		<table style="text-align: center">
			<tr>
				<th colspan="2">Edit Assignment</th>
			</tr>
			<tr>
				<td>Type</td>
			...
			<tr>
				<td>Graduate</td>
				<td><select name="grad_id" id="graduate_id" value='${requestScope["grad_id"]}'>
			...
			<tr>
				<td>Score</td>
				<td><input type="text" id="score" name="score" value='${requestScope["score"]}' /></td>
			</tr>
			<tr>
